    ...
    <body>
        <div class="container">
                ...
                <div class="content-container responsive-top" style="height: 25rem;">
                    ...
                    <div class="right-content">
                        <div class="send-container">
                            ...
                            <p class="explaination-text">1 USD - 0.000088 BTC <a class="info-text">Expected rate No extra fees</a></p>
            ...
            <div class="content-wrapper bottom-container">
                <div class="content-container" style="align-items: flex-start; height: 18rem;">
                    ...
                    <div class="right-content message-parent">
                        <div class="message-container">
                            <div class="message-field" style="margin-right: 1rem;">
                                ...
                                <input class="message-input" placeholder="Full name"/>
                            </div>
                            <div class="message-field">
                                <label>Email</label>
                                <input class="message-input" placeholder="hello@domain.com"/>
                            </div>
                        </div>
                        <div class="message-textarea">
                            <textarea placeholder="Tell us what we can help you with!" class="help-text-area"></textarea>
